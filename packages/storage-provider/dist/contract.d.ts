 ...
 */
export declare class StoragePathNotFoundError extends Error {
...
export declare function hasGetWithToken(provider: StorageProvider): provider is StorageProviderWithTokenRead;
