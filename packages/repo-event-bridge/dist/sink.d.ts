 ...
 */
export type CreateMessageInvoker = (args: CreateMessageArgs) => Promise<{
    messageId?: string;
 ...
 */
export declare class CreateMessageSink implements MessageSink {
    private readonly invoke;
    private readonly messageKind;
    private readonly target;
    private readonly intent?;
    private readonly semanticIntent?;
