...
2. **Current in-flight:** nothing. task-304 + task-305 `completed` (architect-reviewed ✓). **task-306 (Mission-24 Phase C / F) shipped this session across 5 commits + filed `in_review` at the Hub — 538 tests pass.** All 4 list_* tools now support filter + sort on `createdBy.{role, agentId, id}`. Shim-removal eligible ~2026-04-22 AEST (48h soak). Prod backfill executed this session — 846 entities migrated, 0 errors.
...
_(nothing claimed — task-304 + task-305 + task-306 all shipped; task-306 `in_review` at Hub. Architect triage pending on ideas 115/116/118/121/122/124/125/126 and bugs 16/17. bug-14 absorbed into CP4 scope; bug-15 absorbed into CP2 scope per architect task-304 review. Bugs 18/19 RESOLVED via commits ace5cbd + fd0710b.)_
